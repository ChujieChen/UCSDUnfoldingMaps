...
//			map = new UnfoldingMap(this, 200, 50, 700, 500, new EsriProvider.WorldStreetMap());
	    ...
	    for(PointFeature earthquake : earthquakes) {
	    	// call createMarker to create a new SimplePointMarker
	...
	*/
	...
	{	
		...
		fill(255, 0, 0);
		ellipse(50, 120-8, 16, 16);
		fill(255, 255, 0);
		ellipse(50, 160-4, 8, 8);
		fill(0, 0, 255);
		ellipse(50, 200-2, 4, 4);
	}
}
