...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(color(255, 0, 0));
		triangle(50, 100, 50-6, 100+10, 50+6, 100+10);
		fill(0, 0, 0);
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers) {
			...
			for (Marker qm : quakeMarkers) {
				...
				if(eqm.isOnLand()) {
//					String quakeCountry = (String)eqm.getProperty("country");
					String quakeCountry = eqm.getStringProperty("country");
					if(country.equals(quakeCountry)) {
						quakesInCountry = quakesInCountry + 1;
						quakesInOcean = quakesInOcean - 1;
					}
				}
			}
			// Print out earthquakes and countries
			if(quakesInCountry > 0) {
				System.out.print(country + ": ");
				System.out.print(quakesInCountry + "\n");
			}
		}
		
		System.out.print("OCEAN QUAKES: ");
		System.out.println(quakesInOcean);
