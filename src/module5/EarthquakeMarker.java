...
public abstract class EarthquakeMarker extends CommonMarker
{
	...
	public abstract void addCityInCirle(Marker cityMarker);
	public abstract void sendMap(UnfoldingMap map);
	...
	public void showTitle(PGraphics pg, float x, float y)
	{
		...
		pg.pushStyle();
		pg.fill(51, 153, 255);
		int textLength = this.getTitle().length();
		pg.rect(x, y-30, textLength*6, 30);
		pg.fill(0, 0, 0);
		pg.textSize(12);
		pg.text(this.getTitle(), x, y-15);
		pg.popStyle();
	}
